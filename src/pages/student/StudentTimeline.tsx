        ...
        {loading ? (
          ...
          <>
            ...
            {(() => {
              ...
              // Mostrar mensaje de espera solo si alguna evaluación recibida solicita cambios
              if (!allDocEvaluated) {
                const evaluatedCount = docEvalIds.size;
                const totalCount = assignedIds.length;
                // Obtener los conceptos de las evaluaciones recibidas
                const receivedConcepts = Array.from(mostRecentByEvaluator.values()).map((ev: any) => ev.concept);
                // Si alguna evaluación recibida es 'accepted', no mostrar mensaje de correcciones
                if (receivedConcepts.includes('accepted')) {
                  return (
                    <div className="mt-8 p-4 sm:p-6 border-2 border-blue-400/50 rounded-lg bg-blue-50 dark:bg-blue-950/20 space-y-3">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 space-y-2">
                          ...
                          <p className="text-xs text-blue-700 dark:text-blue-300 italic">
                            Cuando todos los evaluadores hayan enviado sus evaluaciones, se mostrará el resultado final.
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                // Si alguna evaluación recibida solicita cambios, mostrar mensaje de correcciones
